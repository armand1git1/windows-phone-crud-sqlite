               ...
               // await messageDialog1.ShowAsync();
                ...
                if (themember.members_family_name.Length == 0)
                {
                   ...
                   // int last_member_id            = members_details.Insert(themember); // create the new space and clear the old's request.  
                    ...
                    var myrequest1 = new request(int.Parse(themember.Id), "all", prefirstname.Text.Trim() + ": would like to join the family group", DateTime.Now.ToString(), 0, "join", 0, "", 0, 0, thefamily);
                ...
                {
                    MessageDialog messageDialog = new MessageDialog("Please enter a valid family name");//Text should not be empty    
                    await messageDialog.ShowAsync();
                }    
